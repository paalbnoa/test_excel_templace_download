...
function configureDataSheet(worksheet, schoolName, selectedSemesters, options = {}) {
  ...
  for (let rowNumber = FIRST_DATA_ROW; rowNumber <= LAST_READY_ROW; rowNumber += 1) {
    ...
    worksheet.getCell(`A${rowNumber}`).dataValidation = {
      type: FIELD_RULES.PersonID.excel.type,
      allowBlank: FIELD_RULES.PersonID.excel.allowBlank,
      showErrorMessage: true,
      errorStyle: "error",
      errorTitle: FIELD_RULES.PersonID.errorTitle,
      error: FIELD_RULES.PersonID.errorMessage,
      formulae: [FIELD_RULES.PersonID.excel.formula(`A${rowNumber}`)]
    };

    worksheet.getCell(`B${rowNumber}`).dataValidation = {
      type: FIELD_RULES.Fornavn.excel.type,
      allowBlank: FIELD_RULES.Fornavn.excel.allowBlank,
      showErrorMessage: true,
      errorStyle: "error",
      errorTitle: FIELD_RULES.Fornavn.errorTitle,
      error: FIELD_RULES.Fornavn.errorMessage,
      formulae: [FIELD_RULES.Fornavn.excel.formula(`B${rowNumber}`)]
    };

    worksheet.getCell(`C${rowNumber}`).dataValidation = {
      type: FIELD_RULES.Etternavn.excel.type,
      allowBlank: FIELD_RULES.Etternavn.excel.allowBlank,
      showErrorMessage: true,
      errorStyle: "error",
      errorTitle: FIELD_RULES.Etternavn.errorTitle,
      error: FIELD_RULES.Etternavn.errorMessage,
      formulae: [FIELD_RULES.Etternavn.excel.formula(`C${rowNumber}`)]
    };

    worksheet.getCell(`D${rowNumber}`).dataValidation = {
      type: FIELD_RULES["Fritatt.sem.avg"].excel.type,
      allowBlank: FIELD_RULES["Fritatt.sem.avg"].excel.allowBlank,
      showErrorMessage: true,
      errorStyle: "error",
      errorTitle: FIELD_RULES["Fritatt.sem.avg"].errorTitle,
      error: FIELD_RULES["Fritatt.sem.avg"].errorMessage,
      formulae: [FIELD_RULES["Fritatt.sem.avg"].excel.formula(`D${rowNumber}`)]
    };

    worksheet.getCell(`E${rowNumber}`).dataValidation = {
      type: FIELD_RULES.Epost.excel.type,
      allowBlank: FIELD_RULES.Epost.excel.allowBlank,
      showErrorMessage: true,
      errorStyle: "error",
      errorTitle: FIELD_RULES.Epost.errorTitle,
      error: FIELD_RULES.Epost.errorMessage,
      formulae: [FIELD_RULES.Epost.excel.formula(`E${rowNumber}`)]
    };

    worksheet.getCell(`F${rowNumber}`).dataValidation = {
      type: FIELD_RULES.Prefiks.excel.type,
      allowBlank: FIELD_RULES.Prefiks.excel.allowBlank,
      showErrorMessage: true,
      errorStyle: "error",
      errorTitle: FIELD_RULES.Prefiks.errorTitle,
      error: FIELD_RULES.Prefiks.errorMessage,
      formulae: [FIELD_RULES.Prefiks.excel.formula(`F${rowNumber}`)]
    };

    worksheet.getCell(`G${rowNumber}`).dataValidation = {
      type: FIELD_RULES.Mobilnummer.excel.type,
      allowBlank: FIELD_RULES.Mobilnummer.excel.allowBlank,
      showErrorMessage: true,
      errorStyle: "error",
      errorTitle: FIELD_RULES.Mobilnummer.errorTitle,
      error: FIELD_RULES.Mobilnummer.errorMessage,
      formulae: [FIELD_RULES.Mobilnummer.excel.formula(`G${rowNumber}`)]
    };
  ...
  worksheet.autoFilter = `A${HEADER_ROW}:${lastColumnLetter}${LAST_READY_ROW}`;
