...
export async function addMacroButtonToWorkbookBuffer(workbookBuffer) {
  ...
  zip.file(vmlDrawingPath, createVmlDrawingXml());
  ...
  zip.file(sheetRelsPath, controlRelationship.xml);
